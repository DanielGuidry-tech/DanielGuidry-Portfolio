---
title: "SEO settings for Daniel Portfolio"
summary: "Manage your Daniel Portfolio's SEO settings."
...
Daniel Portfolio automatically generates meta- and open graph tags for your pages based on the `content.js` file.

## Schema

Daniel Portfolio automatically generates schema tags for your pages based on the `content.js` file.
